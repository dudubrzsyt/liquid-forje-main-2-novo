...
export const Route = createFileRoute("/processo")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Do briefing ao lançamento: descoberta, design, desenvolvimento, deploy e suporte. Prazos claros e zero surpresa." },
      { property: "og:title", content: "Como eu trabalho — processo em 5 etapas" },
      { property: "og:description", content: "Descoberta, design, desenvolvimento, deploy e suporte — prazos claros e comunicação direta." },
...
const steps = [
  { icon: Search, title: "1 · Descoberta", time: "1-2 dias", desc: "Entendo seu negócio, público e objetivo. Defino escopo, referências e métricas de sucesso." },
  { icon: PenTool, title: "2 · Design", time: "3-6 dias", desc: "Protótipo navegável com identidade visual, tipografia e microinterações aprovadas por você." },
  { icon: Code2, title: "3 · Desenvolvimento", time: "5-20 dias", desc: "Código TypeScript limpo, responsivo em celular/tablet/PC/TV, SEO técnico e acessibilidade." },
  { icon: Rocket, title: "4 · Lançamento", time: "1 dia", desc: "Deploy, domínio, analytics, testes de performance e checklist de qualidade antes do ar." },
  { icon: LifeBuoy, title: "5 · Suporte", time: "30-90 dias", desc: "Ajustes, monitoramento e melhorias contínuas. Você nunca fica sozinho depois da entrega." },
];
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6">
            ...
            <Reveal as="li" key={title} delay={i * 80} className="list-none">
              <div className="glass-panel p-7 h-full hover-lift">
                <div className="flex items-center justify-between">
                  ...
                  <span className="rounded-full glass px-3 py-1 text-[11px] font-semibold text-white/80">{time}</span>
                </div>
      ...
      <section className="py-16">
        <Reveal><h2 className="text-3xl md:text-4xl font-black text-white text-center">Minhas <span className="text-gradient">garantias</span></h2></Reveal>
        ...
        <Reveal className="mt-8 text-center">
          <Link to="/faq" className="inline-flex rounded-full glass px-6 py-3 font-semibold text-white transition hover:-translate-y-0.5">
      ...
      <section className="pb-20 grid gap-8 lg:grid-cols-2 items-center">
        <Reveal variant="left">
          <h2 className="text-3xl md:text-4xl font-black text-white">Vamos começar sua <span className="text-gradient">descoberta</span>.</h2>
          <p className="mt-3 text-white/70 max-w-lg">Primeira conversa é gratuita e sem compromisso.</p>
        </Reveal>
