    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="glass-panel max-w-md text-center p-10">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="rounded-full glass px-4 py-2 text-sm font-medium text-white">
            Início
          </a>
        </div>
      </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Diamante.dev — Sites modernos que vendem" },
      {
        name: "description",
        content:
          "Criação de sites modernos e sofisticados: landing pages, institucionais, e-commerce e projetos premium. Feito por Igor Eduardo, desenvolvedor full-stack.",
      },
      ...
      { property: "og:title", content: "Diamante.dev — Sites modernos que vendem" },
      {
        ...
        content:
          "Landing pages, institucionais, e-commerce e projetos premium com design sofisticado e performance real.",
      },
