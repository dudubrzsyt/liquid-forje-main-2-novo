...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Landing pages, institucionais, e-commerce e projetos premium — design sofisticado, performance real e conversão." },
    ],
  }),
  component: Home,
});
  ...
  <p className="mt-5 max-w-xl text-lg leading-relaxed">
    ...
    Do landing page ao e-commerce corporativo — feitos à mão em TypeScript.
                ...
                <div className="mt-4 flex flex-wrap gap-3">
                  ...
                  >
                    Ver pacotes <ArrowRight className="ml-1 inline h-4 w-4 group-hover:translate-x-1 transition" />
                  </Link>
        ...
        <div className="mx-auto max-w-7xl px-10 sm:px-15 lg:px-20 mt-16 sm:mt-24">
          ...
          <section id="features" className="py-40">
            ...
            <div className="grid gap-5 md:grid-cols-3">
              {[
                { icon: Zap, title: "Performance brutal", desc: "Otimizado para celular, PC, tablet e TV. Score 95+ no Lighthouse.", },
                { icon: ShieldCheck, title: "Confiança visual", desc: "Design premium com vidro, shaders e tipografia sob medida.", },
                { icon: Rocket, title: "Pronto pra escalar", desc: "Arquitetura moderna em TypeScript, APIs integradas e SEO nativo.", },
          ...
          <section className="py-20">
            <div className="flex flex-wrap items-end justify-between gap-4 mb-10">
              <div>
                <h2 className="text-3xl md:text-5xl font-black text-slate-900">Vitrine <span className="text-gradient">visual</span></h2>
                <p className="mt-2 text-slate-600">Um gosto do que entregamos.</p>
              </div>
              <Link to="/vendas" className="rounded-full px-5 py-2.5 text-sm font-semibold text-slate-900 border border-slate-200 hover:bg-slate-50 transition">
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-black/0 group-hover:bg-black/60 transition-colors duration-300">
                      <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-center px-6">
                        ...
                        <p className="mt-2 text-sm text-white/90">Design, performance e conversão.</p>
                      </div>
                    </div>
                  </Link>
                </Reveal>
          ...
          <section className="py-16">
            <Reveal className="text-center max-w-2xl mx-auto mb-10">
              <h2 className="text-3xl md:text-5xl font-black text-slate-900">Explore <span className="text-gradient">antes de decidir</span></h2>
              <p className="mt-4 text-slate-600">Cases, método de trabalho e respostas para todas as dúvidas.</p>
            </Reveal>
            <div className="grid gap-5 md:grid-cols-3">
              {[
                { to: "/portfolio" as const, title: "Portfólio", desc: "Cases reais com métricas de conversão e performance." },
                { to: "/processo" as const, title: "Processo", desc: "As 5 etapas do briefing ao lançamento, com prazos." },
                { to: "/faq" as const, title: "FAQ", desc: "Prazos, pagamento, domínio, manutenção e garantias." },
              ].map((c, i) => (
                <Reveal key={c.to} delay={i * 90} variant="zoom" className="h-full">
                  <Link to={c.to} className="group bg-white border border-slate-100 p-7 h-full flex flex-col rounded-2xl hover:shadow-lg transition">
            ...
            <div className="grid gap-10 lg:grid-cols-2 items-center">
              <Reveal variant="left">
                ...
                <p className="mt-4 text-slate-600 max-w-lg">
                  Preencha o formulário e envio direto pro meu WhatsApp. Respondo em até 24h com um plano personalizado.
                </p>
              </Reveal>
